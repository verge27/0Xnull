...
const staticPages = [
  ...
  { path: '/docs', priority: '0.8', changefreq: 'monthly', lastmod: '2026-03-01' },
  { path: '/canary', priority: '0.6', changefreq: 'weekly', lastmod: '2026-03-01' },
  ...
  { path: '/work', priority: '0.7', changefreq: 'hourly', lastmod: '2026-08-24' },
