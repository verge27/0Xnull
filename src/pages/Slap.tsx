        ...
        <section className="relative pt-[calc(6rem+env(safe-area-inset-top))] pb-20 md:pt-[calc(9rem+env(safe-area-inset-top))] md:pb-32 overflow-visible">
          ...
          <div className="container relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl leading-[1.2] md:leading-[1.2] lg:leading-[1.2] font-bold mb-8 bg-gradient-to-r from-red-500 via-red-400 to-yellow-500 bg-clip-text text-transparent drop-shadow-2xl">
                Slap Fighting
              </h1>
