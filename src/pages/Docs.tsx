        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <Section id="markets" icon={Scale} title="Market resolution">
              <p>
                Every v2 prediction market is a two-sided dollar ledger. Treasury liquidity seeds each eligible market from combined bookmaker odds and rotates back into the pool as markets settle; user stakes then
