...
const TokenCashout = lazy(() => import("./pages/TokenCashout"));
...
const LendingPrivacyPage = lazy(() => import("./pages/LendingPrivacy"));
            ...
            <PrivateKeyAuthProvider>
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route path="/lending/:asset" element={<LendingPool />} />
                  ...
                  <Route path="/lending/privacy" element={<LendingPrivacyPage />} />
                  ...
                  <Route path="/token/cashout" element={<TokenCashout />} />
