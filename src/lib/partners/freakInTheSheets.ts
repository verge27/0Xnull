...
const remoteEggPurpleImg = '/images/products/remote-egg-purple.jpg';
import clitoralSquirrelImg from '@/assets/freakinthesheets/clitoral-squirrel.jpg';
const sportsheetsBarImg = '/images/products/sportsheets-spreader.jpg';
...
const idFreeLubeImg = '/images/products/id-free-lube.jpg';
import waterLubeImg from '@/assets/freakinthesheets/water-lube.jpg';
const fleshlubeIceImg = '/images/products/fleshlube-ice.jpg';
...
const dualisticDoubleImg = '/images/products/dualistic-double.jpg';
const wonderloveRemoteImg = '/images/products/wonderlove-remote.jpg';
const lewandSwerveImg = '/images/products/lewand-swerve.jpg';
const balldoPurpleImg = '/images/products/balldo-purple.jpg';
const evolvedStrapOnImg = '/images/products/evolved-strapon.jpg';
