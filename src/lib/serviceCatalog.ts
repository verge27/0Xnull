...
export const SERVICE_GROUPS: Record<ServiceGroup, { label: string; blurb: string }> = {
  ...
  predictions: {
    label: 'Predictions',
    blurb: 'Binary markets on public outcomes. Stakes spend your existing token balance; wins and refunds return to it.',
  },
  infra: {
...
export const SERVICE_CATALOG: CatalogService[] = [
  ...
  {
    name: 'Tor, Monero & Darkweb Services Hub',
    what: 'The platform is built as a hub for Tor, Monero and darkweb services, with mature engineering: a hidden-service mirror, XMR settlement, client-side PGP encryption and no accounts.',
    price: 'Open access',
    status: 'live',
    group: 'infra',
    href: '/external-links',
