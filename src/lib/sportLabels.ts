...
const DESCRIPTION_PREFIXES: Record<string, { sport: string; sportLabel: string; sportEmoji: string; leagueLabel: string }> = {
  ...
  'conference league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Conference League' },
  ...
  'scottish premiership': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Scottish Premiership' },
  'scottish premier league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Scottish Premiership' },
  'spfl': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Scottish Premiership' },
  'championship': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Championship' },
  'efl championship': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Championship' },
  'fa cup': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'FA Cup' },
  'carabao cup': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Carabao Cup' },
  'league cup': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'League Cup' },
  'copa del rey': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Copa del Rey' },
  'dfb pokal': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'DFB-Pokal' },
  'coppa italia': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Coppa Italia' },
  'coupe de france': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Coupe de France' },
  'belgian pro league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Belgian Pro League' },
  'swiss super league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Swiss Super League' },
  'austrian bundesliga': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Austrian Bundesliga' },
  'russian premier league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Russian Premier League' },
  'turkish super lig': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Turkish Super Lig' },
  'super lig': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Turkish Super Lig' },
  'greek super league': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Greek Super League' },
  ...
  'euros': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Euros' },
  'euro': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Euros' },
  'copa america': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Copa America' },
  'afcon': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'AFCON' },
  'asian cup': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Asian Cup' },
  'concacaf': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'CONCACAF' },
  'copa libertadores': { sport: 'soccer', sportLabel: 'Soccer', sportEmoji: '⚽', leagueLabel: 'Copa Libertadores' },
  
  // Field Sports
  'lacrosse': { sport: 'fieldsports', sportLabel: 'Lacrosse', sportEmoji: '🥍', leagueLabel: 'Lacrosse' },
  'pll': { sport: 'fieldsports', sportLabel: 'Lacrosse', sportEmoji: '🥍', leagueLabel: 'PLL' },
  'nll': { sport: 'fieldsports', sportLabel: 'Lacrosse', sportEmoji: '🥍', leagueLabel: 'NLL' },
  'premier lacrosse': { sport: 'fieldsports', sportLabel: 'Lacrosse', sportEmoji: '🥍', leagueLabel: 'PLL' },
  'field hockey': { sport: 'fieldsports', sportLabel: 'Field Hockey', sportEmoji: '🏑', leagueLabel: 'Field Hockey' },
  'hockey india': { sport: 'fieldsports', sportLabel: 'Field Hockey', sportEmoji: '🏑', leagueLabel: 'Hockey India' },
  'fih': { sport: 'fieldsports', sportLabel: 'Field Hockey', sportEmoji: '🏑', leagueLabel: 'FIH' },
  'polo': { sport: 'fieldsports', sportLabel: 'Polo', sportEmoji: '🐴', leagueLabel: 'Polo' },
  'argentine polo': { sport: 'fieldsports', sportLabel: 'Polo', sportEmoji: '🐴', leagueLabel: 'Argentine Polo' },
